...
router.route("/api/restoreDefaultReceiptSettings").post(settings.restoreDefaultReceiptSettings);
router.route("/api/restoreDefaultConfigSettings").post(settings.restoreDefaultConfigSettings);

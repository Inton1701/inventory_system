      ...
      <div class="page-header">
        ...
        <div class="page-btn">
          <a
            ...
            ><i data-feather="plus-circle" class="me-2"></i>Add New Brand</a
          >
        </div>
      </div>
    ...
    const updateBrand = async () => {
      try {
        ...
        const response = await axios.patch(
          `${apiURL}/edit_brand/${editBrand.value._id}`,
          formData
        );
